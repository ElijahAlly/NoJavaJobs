...
for job in jobs:
    # linkedin grabs the company link everytime (as far as I can tell)
...
jobs.to_csv(f"jobspy_outputs/linkedin_jobspy_{current_time}.csv", index=False) # to_xlsx
